package simple_test_java.my_test.src.t20231127.exam05_answer;
    ...
    public void remove(E e) {
        for (int i=0; i<array.length; i++) {
            if(array[i] != null & array[i].equals(e)) {
                ...
                // System.arraycopy(원본배열,시작인덱스,복제할배열,시작인덱스,복제할 길이)
                System.arraycopy(this.array, i+1, newArray, i, array.length-(i+1));
                this.array = newArray;
                length--;
                capacity--;
                break;
