...
public class QNABoardDAOImpl implements QNABoardDAO {
	...
	public void boardWrite(BoardVO board) {
		// 삽입된 원본글 번호를 그룹으로 묶을 수 있도록 qna_re_ref 컬럼 값을 등록된 게시글 번호로 지정
		...
		try {
			...
			sql = "UPDATE qna SET qna_re_ref = LAST_INSERT_ID() WHERE qna_num = LAST_INSERT_ID()";
