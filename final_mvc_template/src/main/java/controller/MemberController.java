...
public class MemberController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String command = requestPath.substring(contextPath.length()+1); // 더하기 1부터 짤라내는 것
		System.out.println("mc - requestPath : " + requestPath);
		System.out.println("mc - requestPath : " + contextPath);
		// 해당 서블릿으로 전달된 요청
		System.out.println("mc - requestPath : " + command);
