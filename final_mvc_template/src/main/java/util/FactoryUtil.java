...
public interface FactoryUtil {
	...
	/*
	 * RequestDispatcher 를 이용해 유효한 페이지 일 경우 forward로 출력 페이지 전환
	 */
	public static void nextPage(HttpServletRequest request, HttpServletResponse response, String next) throws ServletException, IOException {
