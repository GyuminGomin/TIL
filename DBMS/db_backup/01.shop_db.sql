...
INSERT INTO `deletedmembertbl` VALUES ('Sang','상달이','경기 성남시 분당구','2023-11-29');
...
INSERT INTO `membertbl` VALUES ('Dang','당탕이','경기도 부천시 중동'),('Han','한주연','인천 남구 주안동'),('Jee','지운이','서울 은평구 중산동');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_deletedMemberTbl` AFTER DELETE ON `membertbl` FOR EACH ROW -- 모든 행에 대하여 적용
begin
...
-- Dump completed on 2023-11-29 15:11:40
