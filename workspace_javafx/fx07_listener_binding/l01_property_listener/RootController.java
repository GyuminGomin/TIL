	...
	public void initialize(URL location, ResourceBundle bundle) {
		...
		slider.valueProperty().addListener(new ChangeListener<Number>() {
			...
			public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
				System.out.println(observable); // 속성
				System.out.println("oldValue : " + oldValue); // 변하기 이전 값
				System.out.println("newValue : " + newValue); // 변하고 난 값
			}
		});
		...
		toggle.selectedProperty().addListener(new ChangeListener<Boolean>() {
			...
			@Override
			public void changed(ObservableValue<? extends Boolean> target, Boolean oldValue, Boolean newValue) {
