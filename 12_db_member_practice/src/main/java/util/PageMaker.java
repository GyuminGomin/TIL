package util;
/*
 * 요청한 페이지 정보에 따라 이동가능한 페이지 번호를 제공 및 계산하는 class
...
public class PageMaker {
	...
	/*
	 * displayPageNum와 사용자가 요청한 페이지 번호에 따라 현재 페이지에서 보여줄 이동가능한 게시판 화면의 시작 페이지 번호
	 */
	private int startPage;
	
	/*
	 * displayPageNum와 사용자가 요청한 페이지 번호에 따라 현재 페이지에서 보여줄 이동가능한 게시판 화면의 마지막 페이지 번호
	 */
	private int endPage;
	 ...
	 * @return 전달받은 페이지 번호로 페이징 처리에 필요한 파라미터를 이용해서 QueryString 생성 반환
	 */
	public String makeQuery(int page) { // 쿼리스트링을 만들어주는 녀석
