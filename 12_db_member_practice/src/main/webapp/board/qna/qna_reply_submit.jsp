...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- qna_reply_submit.jsp 새로운 질문 글 작성-->
...
<%
	...
	try {
		...
		pstmt.setInt(5, qna_re_lev + 1); // 원본 글보다 1 커야함 (아래 배치될 것이므로)
		pstmt.setInt(6, qna_re_seq + 1); // 원본 글보다 1 커야함 (아래 배치될 것이므로)
		pstmt.setInt(7, qna_writer_num); // 작성자 번호
