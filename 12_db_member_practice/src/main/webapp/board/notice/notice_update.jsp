	...
	try {
		...
		if (rs.next()) {
			n = new NoticeVO(
				...
				rs.getString(2),		// notice_title
				rs.getString(3),		// notice_author
				rs.getString(4),		// notice_comment
				rs.getString(5),		// notice_
	...
	<form action="notice_update_submit.jsp" method="POST">
		...
		<table>
			...
			<tr>
				<td>제목</td>
				<td>
					<input type="text" value="<%=n.getNotice_title() %>" style="width:100%;" name="notice_title" autofocus required />
				</td>
			</tr>
			<tr>
				<td>내용</td>
